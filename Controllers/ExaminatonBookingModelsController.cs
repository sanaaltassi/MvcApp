...
namespace MvcApp.Controllers
{
    public class ExaminatonBookingModelsController : Controller
    {
        ...
        {
            var ExaminatonBooking = _context.ExaminatonBookingModel.Where(s => s.PatientId == id);
            return View(await ExaminatonBooking.ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Illness")] ExaminatonBookingModel examinatonBookingModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Illness")] ExaminatonBookingModel examinatonBookingModel)
        {

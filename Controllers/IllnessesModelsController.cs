...
namespace MvcApp.Controllers
{
    public class IllnessesModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,IllnessesTypes")] IllnessesModel illnessesModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,IllnessesTypes")] IllnessesModel illnessesModel)
        {
